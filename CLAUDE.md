...
유튜브 **몰락 다큐멘터리** 채널 대본 제작 도구. "대본 만들어줘 — 노키아" 한마디로 적합도 평가 → 리서치 → 스토리 설계 → 집필 → 검수 → 완성본(대본·썸네일제목·업로드정보·타임스탬프)까지 진행한다.
...
| "타임스탬프 채워줘" · "타임스탬프 넣어줘" (+ 완성 영상) | `.claude/skills/timestamp/SKILL.md` | 완성 영상 전사 → `03_업로드정보.md`·`04_타임스탬프.txt`의 챕터 시각을 실측값으로 교체 |
